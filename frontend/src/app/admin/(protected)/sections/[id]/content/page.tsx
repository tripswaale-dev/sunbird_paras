...
import { getSection, type AdminSection } from '@/lib/admin/sections';
import { SectionContentShell } from '@/components/admin/sections/SectionContentShell';
import { Loader } from '@/components/ui/loader';

export default function AdminSectionContentPage() {
  ...
  return <SectionContentShell section={section} />;
}
