...
import { adminPackageToFormValues, getPackage, type AdminPackage } from '@/lib/admin/packages';
import { PackageForm } from '@/components/admin/packages/PackageForm';
import { Loader } from '@/components/ui/loader';

export default function AdminPackageEditClient() {
  ...
  return (
    <PackageForm
      mode="edit"
      packageId={pkg.id}
      defaultValues={adminPackageToFormValues(pkg)}
    />
  );
}
