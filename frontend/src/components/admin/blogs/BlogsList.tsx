...
export function BlogsList() {
  ...
  const updateParams = useCallback(
    (updates: { search?: string; is_active?: string; page?: number; deleted?: string }) => {
  ...
  const hasFilters = Boolean(search.trim() || isActiveParam);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
        <div className="flex-1">
          <label htmlFor="blog-search" className="mb-1.5 block text-sm font-medium text-gray-700">
            Search
          </label>
          <input
            id="blog-search"
            ...
            placeholder="Search by title, slug, author, or excerpt"
        ...
        <div className="sm:w-48">
          <label htmlFor="blog-active" className="mb-1.5 block text-sm font-medium text-gray-700">
            Status
          </label>
          <select
            id="blog-active"
                ...
                <tbody className="divide-y divide-gray-100">
                  {blogs.map((blog) => (
                    <tr key={blog.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-700">{blog.slug}</td>
                      <td className="px-4 py-3 text-sm text-gray-700">{blog.category}</td>
