...
export const aboutPageContent: PageContentResponse = {
  pageKey: 'about',
  heroImage: '/images/destinations/ladakh.jpg',
  heroTitle: 'The Story Behind Sunbird Vacations',
  heroSubtitle:
    "Travel isn't just about reaching a destination. It's about collecting stories, creating memories, and discovering a part of yourself along the way.",
  introText: null,
  body: aboutBody,
  contactPhone: null,
  contactEmail: null,
