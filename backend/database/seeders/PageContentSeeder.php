...
class PageContentSeeder extends Seeder
{
    ...
    {
        $aboutBody = <<<'CONTENT'
Two years ago, Sunbird Vacations was born from a simple dream—to transform a passion for travel into meaningful experiences for others. What started as an idea has now grown into a travel company built on trust, personalized service, and the joy of helping people explore the world with confidence.
...
CONTENT;
        ...
        PageContent::updateOrCreate(
            ['page_key' => PageContent::PAGE_KEY_ABOUT],
            [
                'hero_image' => '/images/destinations/ladakh.jpg',
                'hero_title' => 'The Story Behind Sunbird Vacations',
                'hero_subtitle' => 'Travel isn\'t just about reaching a destination. It\'s about collecting stories, creating memories, and discovering a part of yourself along the way.',
                'intro_text' => null,
                'body' => $aboutBody,
                'contact_phone' => null,
                'contact_email' => null,
        ...
        PageContent::updateOrCreate(
            ['page_key' => PageContent::PAGE_KEY_CONTACT],
            [
                'hero_image' => '/images/destinations/kerala.jpg',
                'hero_title' => 'Contact Us',
                'hero_subtitle' => 'Let\'s start planning your next great adventure.',
                'intro_text' => 'Planning your next dream vacation? Have questions about our packages? Our travel experts are here to help you design the perfect itinerary.',
                'body' => null,
                'contact_phone' => '+91 81412 67610',
                'contact_email' => 'vacations.sunbird@gmail.com',
                'contact_address' => 'A-709, Krish elite, S P ring road- service road, Nikol- Ahmedabad, Gujarat 382350',
